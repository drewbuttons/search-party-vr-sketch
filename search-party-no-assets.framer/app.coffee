...
#Import audio files
audioA = new AudioPlayer audio: "images/songs/dng_onstreet1.mp3"
# 
audioB = new AudioPlayer audio: "images/songs/dng_onstreet2.mp3"
# 
audioC = new AudioPlayer audio: "images/songs/dng_inclub1.mp3"
# 
audioD = new AudioPlayer audio: "images/songs/dng_orig.mp3"
...
notes1.center()
notes1.y = notes1.y - arrowHeight - 100
...
notes2.center()
notes2.y = notes2.y - arrowHeight - 25
notes2.x = notes2.x + 200
...
notes3.center()
notes3.y = notes3.y - arrowHeight - 25
notes3.x = notes3.x - 200

where = new Layer
	width: 514
	height: 29
	image: "images/opener/whereSound.png"
	scale: 0.6
...
#Arrow spin states for opening sequence
...
# Show stuff in opening sequence functions
